...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = // таблица ошибок
	{
		...
		ERROR_ENTRY(120, "LexTable: превышен допустимый размер таблицы"),
		ERROR_ENTRY(121, "Превышена длина имени переменной или имя переменной недопустимо"),
		ERROR_ENTRY(122, "IdTable: превышен допустимый размер таблицы"),
		ERROR_ENTRY(123, "LexemaAnasysis: нераспознанная лексема"),
		ERROR_ENTRY(124, "LexemaAnasysis: нарушен формат строкового литерала"),
		ERROR_ENTRY(125, "LexemaAnasysis: перезапись идентификатора"),
		ERROR_ENTRY(126, "LexemaAnasysis: неизвестная переменная"),
		ERROR_ENTRY(127, "LexemaAnasysis: превышена длина строкового литерала"),
		ERROR_ENTRY(128, "Не удалось создать файл с таблицами лексем и идентификаторов"),
		ERROR_ENTRY(129, "LexemaAnasysis: найдено несколько точек входа (main)"),
		ERROR_ENTRY(130, "LexemaAnasysis: отсутствие ключевого слова declare при объявлении переменной"),
